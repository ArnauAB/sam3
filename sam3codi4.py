...
# Paths
####################################
input_folder = "/mnt/gpid08/datasets/micromobility/smartin/recordings/2026-03-03/"
output_folder = "results_carpeta"
...
for i, filename in enumerate(image_files, start=1):
    ...
    output = processor.set_text_prompt(state=inference_state, prompt="bike lane")                                     
